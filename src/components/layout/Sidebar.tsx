    ...
    <aside className="w-64 bg-white border-r border-gray-200 flex flex-col h-full">
      ...
      <nav className="flex-1 overflow-y-auto py-4">
        <ul className="space-y-1">
          ...
          {/* Active Section */}
          <li className="pt-2">
            <a href="#" className="flex items-center justify-between px-6 py-2.5 text-[#6b21a8] bg-purple-50/50 border-l-4 border-[#6b21a8]">
            ...
            <ul className="py-2 space-y-1">
              <li>
                <a href="#" className="block px-14 py-2 text-xs font-medium text-[#6b21a8]">
                  Conciliación por cliente
                </a>
              </li>
              <li>
                <a href="#" className="block px-14 py-2 text-xs text-gray-500 hover:text-gray-700">
                  Transacciones no<br/>conciliadas
                </a>
              </li>
            </ul>
          </li>
