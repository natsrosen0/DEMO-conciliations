  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-4 shadow-sm">
        <h3 className="text-xs font-medium text-gray-500 mb-1 uppercase tracking-wider">Clientes totales</h3>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-4 shadow-sm">
        <div className="flex items-center gap-2 mb-1">
          ...
          <h3 className="text-xs font-medium text-gray-500 uppercase tracking-wider">Transacciones</h3>
        </div>
        <div className="flex items-baseline gap-2">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-4 shadow-sm">
        ...
        <div className="flex items-baseline gap-2">
          <span className="text-2xl font-bold text-green-600">{formatCurrency(totalPagado)}</span>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-4 shadow-sm">
        <div className="flex items-center gap-2 mb-1">
          ...
          <h3 className="text-xs font-medium text-gray-500 uppercase tracking-wider">Por conciliar</h3>
        </div>
        <div className="flex items-baseline gap-2">
